...
public class TelaUsuario extends javax.swing.JInternalFrame {
    ...
    ResultSet rs = null; // exibe o resultado da conexao feita com o banco
    ...
    //metodo para alterar a tabela usuario
    private void alterar() {
        ...
        try {
            ...
            if ((txtUsuId.getText().isEmpty()) || (txtUsuNome.getText().isEmpty()) || (txtUsuLogin.getText().isEmpty()) || (txtUsuSenha.getText().isEmpty())) {
                ...
                //System.out.println(int);
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Dados do usuários alterados com Sucesso!");
                    txtUsuId.setText(null);
                    txtUsuNome.setText(null);
                    txtUsuFone.setText(null);
                    txtUsuLogin.setText(null);
            ...
            if (confirmacao == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    if (apagado > 0) {
                        ...
                        txtUsuFone.setText(null);
                        txtUsuSenha.setText(null);
                        JOptionPane.showMessageDialog(null, "Campos removidos com sucesso.");
                    }
    ...
    private void initComponents() {
        ...
        btnUsuCreate.setMaximumSize(new java.awt.Dimension(80, 980));
        ...
        btnUsuRead.setToolTipText("Pesquisa");
        btnUsuRead.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnUsuRead.setMaximumSize(new java.awt.Dimension(80, 980));
        ...
        btnUsuUpdate.setMaximumSize(new java.awt.Dimension(80, 980));
        ...
        btnUsuDelete.setMaximumSize(new java.awt.Dimension(80, 980));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtUsuId, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabel7))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtUsuFone, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(cdoUsuPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
